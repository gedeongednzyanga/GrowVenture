                        ...
                        <div class="row ">
                            <div class="col-sm-12 ">
                                <div class="form-group ">
                                    <input class="form-control valid " name="nom" id="name" autocomplete="off"
                                        type="text " onfocus="this.placeholder='' "
                                        onblur="this.placeholder='Enter your names' " placeholder="Enter your names ">
                                </div>
                            </div>
                            <div class="col-sm-12 ">
                                <div class="form-group ">
                                    <input class="form-control valid " name="mail" id="email" autocomplete="off"
                            ...
                            <div class="col-12 ">
                                <div class="form-group ">
                                    <input class="form-control " name="confirm" id="confirmpass" autocomplete="off"
                                        type="password" onfocus="this.placeholder='' "
                                        onblur="this.placeholder='Confirm Password' " placeholder="Confirm Password ">
                                </div>
                            </div>
                        </div>
                        <div class="form-group mt-3 ">
                            <button name="action" value="create" id="btn-create"
                                class="button button-contactForm boxed-btn ">Create Acount</button>
                        </div>
                    </div>
