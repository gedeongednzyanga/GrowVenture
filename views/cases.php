...
<body>
    ...
    <main>
        ...
        <div class="slider-area ">
            <!-- Mobile Menu -->
            <div class="single-slider slider-height2 d-flex align-items-center" data-background="views/assets/img/hero/gallery_hero.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
        ...
        <div class="completed-cases section-padding3">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-cases-img  size mb-30">
                            <img src="views/assets/img/service/completed_case_3.png" alt="">
                            <!-- img hover caption -->
                            <div class="single-cases-cap single-cases-cap2">
                                <h4><a href="case_details.html">Marketing Strategy</a></h4>
                                <p>Completely impact synergistic mindshare</p>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-cases-img  size mb-30">
                            <img src="views/assets/img/service/completed_case_4.png" alt="">
                            <!-- img hover caption -->
                            <div class="single-cases-cap single-cases-cap2">
                                <h4><a href="case_details.html">Marketing Strategy</a></h4>
                                <p>Completely impact synergistic mindshare</p>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-cases-img  size mb-30">
                            <img src="views/assets/img/service/completed_case_5.png" alt="">
                            <!-- img hover caption -->
                            <div class="single-cases-cap single-cases-cap2">
                                <h4><a href="case_details.html">Marketing Strategy</a></h4>
                                <p>Completely impact synergistic mindshare</p>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-cases-img  size mb-30">
                            <img src="views/assets/img/service/completed_case_6.png" alt="">
                            <!-- img hover caption -->
                            <div class="single-cases-cap single-cases-cap2">
                                <h4><a href="case_details.html">Marketing Strategy</a></h4>
                                <p>Completely impact synergistic mindshare</p>
