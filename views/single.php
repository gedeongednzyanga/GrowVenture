                ...
                <div class="col-lg-8 posts-list">
                        ...
                        <div class="navigation-area">
                            <div class="row">
                                <div
                                    ...
                                    <div class="thumb">
                                        <a href="#">
                                            <img class="img-fluid" src="views/assets/img/post/preview.png" alt="">
                                        </a>
                                    </div>
                                    <div class="arrow">
                                        <a href="#">
                                ...
                                <div
                                    ...
                                    <div class="thumb">
                                        <a href="#">
                                            <img class="img-fluid" src="views/assets/img/post/next.png" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="blog-author">
                        <div class="media align-items-center">
                            <img src="views/assets/img/blog/author.png" alt="">
                    ...
                    <div class="comments-area">
                        ...
                        <div class="comment-list">
                            <div class="single-comment justify-content-between d-flex">
                                <div class="user justify-content-between d-flex">
                                    <div class="thumb">
                                        <img src="views/assets/img/comment/comment_1.png" alt="">
                                    </div>
                                    <div class="desc">
                                        <p class="comment">
                        ...
                        <div class="comment-list">
                            <div class="single-comment justify-content-between d-flex">
                                <div class="user justify-content-between d-flex">
                                    <div class="thumb">
                                        <img src="views/assets/img/comment/comment_2.png" alt="">
                                    </div>
                                    <div class="desc">
                                        <p class="comment">
                                            Multiply sea night grass fourth day sea lesser rule open subdue female fill
                        ...
                        <div class="comment-list">
                            <div class="single-comment justify-content-between d-flex">
                                <div class="user justify-content-between d-flex">
                                    <div class="thumb">
                                        <img src="views/assets/img/comment/comment_3.png" alt="">
                                    </div>
                                    <div class="desc">
                                        <p class="comment">
                                            Multiply sea night grass fourth day sea lesser rule open subdue female fill
