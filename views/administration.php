...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    ...
    <script src="views/assets/admin/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>
    <script src="views/assets/admin/dist/js/adminlte.js"></script>
    <script src="views/assets/admin/dist/js/demo.js"></script>
    <script src="views/assets/admin/jquery-mousewheel/jquery.mousewheel.js"></script>
    <script src="views/assets/admin/raphael/raphael.min.js"></script>
    <script src="views/assets/admin/jquery-mapael/jquery.mapael.min.js"></script>
    <script src="views/assets/admin/jquery-mapael/maps/usa_states.min.js"></script>
    <!-- ChartJS -->
    <script src="views/assets/admin/chart.js/Chart.min.js"></script>

    <!-- PAGE SCRIPTS -->
    <script src="views/assets/admin/dist/js/pages/dashboard2.js"></script>
</body>
