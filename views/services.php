...
<head>
    ...
    <title>GrowVenture | Services</title>
...
<body>
    ...
    <main>
        ...
        <div class="slider-area ">
            <!-- Mobile Menu -->
            <div class="single-slider slider-height2 d-flex align-items-center" data-background="views/assets/img/hero/services_hero.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
            ...
            <div class="container">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-services text-center mb-30">
                            ...
                            <div class="services-caption">
                                ...
                                <p>La planification stratégique est un processus de développement des stratégies...</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                ...
                <div class="row justify-content-center">
                    <div class="room-btn pt-50">
                        <button class="border-btn" id="more-service">More Services</button>
                    </div>
                </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-services text-center mb-30">
                            ...
                            <div class="services-caption">
                                ...
                                <p>La gestion d’affaires dans GrowVenture et notamment le planning d’affaires, permettent...</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-services text-center mb-30">
                            ...
                            <div class="services-caption">
                                ...
                                <p>Le plan d’affaires est l’un des piliers les plus importants de toute nouvelle entreprise...</p>
                            </div>
                        </div>
                    </div>
                </div>
