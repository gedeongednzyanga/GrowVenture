            ...
            <div class="d-none d-sm-block mb-5 pb-4 ">
                <div id="map " style="height: 480px; position: relative; overflow: hidden; ">
                    ...
                    66px; height: 26px; user-select: none; border: 0px; padding: 0px; margin: 0px; "></div>
                            ...
                            <div
                                style="background-color: white; padding: 15px 21px; border: 1px solid rgb(171, 171, 171); font-family: Roboto, Arial, sans-serif; color: rgb(34, 34, 34); box-sizing: border-box; box-shadow: rgba(0, 0, 0, 0.2) 0px 4px
                    16px; z-index: 10000002; display: none; width: 300px; height: 180px; position: absolute; left: 315px; top: 150px; ">
                                ...
                                <div style="font-size: 13px; ">Map data ©2019 Google</div><button draggable="false "
                                    ...
                                    style="background: none; display: block; border: 0px;
                    ...
                    text-align: right; vertical-align: middle; display: inline-block; "><a
                    ...
                    right; vertical-align: middle; display: inline-block; "><a
                                ...
                                style="background: none rgb(255, 255, 255); border: 0px;
                    margin: 10px; padding: 0px; position: absolute; cursor: pointer; user-select: none; border-radius: 2px; height: 40px; width: 40px; box-shadow: rgba(0, 0, 0, 0.3) 0px 1px 4px -1px; overflow: hidden; top: 0px; right: 0px; "><img
                    ...
                    " style="height: 18px; width: 18px; "></button>
                            <div draggable="false " class="gm-style-cc "
                                ...
                                <div style="position: relative; padding-right: 6px; padding-left: 6px; box-sizing: border-box; font-family: Roboto, Arial, sans-serif; font-size: 10px; color: rgb(68, 68, 68); white-space: nowrap; direction: ltr; text-align:
                    right; vertical-align: middle; display: inline-block; "><a target="_blank " rel="noopener "
                                        title="Report errors in the road map or imagery to Google " href="https://www.google.com/maps/@-31.197,150.744,9z/data=!10m1!1e1!12b1?source=apiv3&amp;rapsrc=apiv3
                    ...
                    "><button draggable="false " title="Zoom in " aria-label="Zoom in " type="button "
                                            class="gm-control-active " style="background: none; display: block; border: 0px; margin: 0px; padding: 0px; position: relative; cursor: pointer; user-select: none; overflow:
                    ...
                    " style="height: 18px; width: 18px; "></button>
                                        ...
                                        </div><button draggable="false " title="Zoom out " aria-label="Zoom
                    ...
                    " style="height: 18px; width: 18px; "></button>
                                ...
                                <div class="gmnoprint " controlwidth="40 " controlheight="40 "
                                    ...
                                    <div style="width: 40px; height: 40px; "><button draggable="false "
                                            ...
                                            type="button " class="gm-control-active " style="background: none rgb(255, 255,
                    ...
                    " style="height: 18px; width: 18px; "></button>
                                        <button draggable="false " title="Tilt map " aria-label="Tilt map "
                                            ...
                                            style="background: none rgb(255, 255, 255); display: block; border: 0px; margin: 0px; padding:
                    0px; position: relative; cursor: pointer; user-select: none; width: 40px; height: 40px; top: 0px; left: 0px; overflow: hidden; box-shadow: rgba(0, 0, 0, 0.3) 0px 1px 4px -1px; border-radius: 2px; "><img
                        ...
                        <div class="row ">
                            <div class="col-sm-6 ">
                                <div class="form-group ">
                                    ...
                                    <input class="form-control valid " name="sender" id="name" type="text "
