...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      <img src="views/assets/admin/dist/img/AdminLTELogo.png"
           alt="AdminLTE Logo"
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-footer bg-white">
              <ul class="mailbox-attachments d-flex align-items-stretch clearfix">
                ...
                <li>
                  <span class="mailbox-attachment-icon has-img"><img src="views/assets/admin/dist/img/photo1.png" alt="Attachment"></span>
                ...
                <li>
                  <span class="mailbox-attachment-icon has-img"><img src="views/assets/admin/dist/img/photo2.png" alt="Attachment"></span>
