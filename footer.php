                    ...
                    <div class="single-footer-caption mb-50">
                        <div class="single-footer-caption mb-30">
                            ...
                            <div class="footer-logo">
                                <a href="<?= URL ?>"><img src="views/assets/img/logo/logo2Gv.png" alt=""></a>
                            </div>
                            <div class="footer-tittle">
                                <div class="footer-pera">
                                    <p>To be successful, you have to have your heart in your business and your business
                                        in your heart.</p>
                                </div>
                            </div>
                            <!-- social -->
                    ...
                    <div class="col-xl-12 ">
                        <div class="footer-copy-right text-center">
                            <p>
                                ...
                                </script> All rights reserved | <a href="https://growventure.com" target="_blank">Grow
                                    Venture</a>
                                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            </p>
                        </div>
...
<!-- Date Picker -->
<script src="views/assets/js/gijgo.min.js"></script>
...
<script src="views/assets/js/pagination.js"></script>